...
{/* modals */}
            ...
            <li className={"md:hover:bg-primary md:hover:text-primary-content"}>
                <a><MdCategory className={' text-2xl'}/>Categories</a>
            </li>
            <li className={"md:hover:bg-primary md:hover:text-primary-content"}>
                <a><MdStore className={' text-2xl'}/>Vendors</a>
            </li>
            <li className={"md:hover:bg-primary md:hover:text-primary-content"}>
                <a><MdDashboard className={' text-2xl'}/>Dashboard</a>
            </li>
            <li className={"md:hover:bg-primary md:hover:text-primary-content"}>
                <a><MdFilterAlt className={' text-2xl'}/>Filter</a>
            </li>
            <li className={"md:hover:bg-primary md:hover:text-primary-content"}>
                <a><MdShoppingBasket className={' text-2xl'}/>Orders</a>
            </li>
            {/*<li className={""}>*/}
