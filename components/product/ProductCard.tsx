...
function ProductCard(props : any) {
    const {product}=props
    return (
            <div  className="card w-44 sm:w-64 bg-base-100 shadow-xl m-1 cursor-pointer border border-base-content/10">
            ...
            <div className="card-body items-center text-center p-2">
                ...
                <div className="text-lg sm:text-xl text-base-content/80 font-bold hover:text-base-content">{product.name}</div>
                </Link>
